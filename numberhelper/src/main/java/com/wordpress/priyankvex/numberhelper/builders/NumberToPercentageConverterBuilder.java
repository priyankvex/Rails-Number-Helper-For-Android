 ...
 * Builder for {@link com.wordpress.priyankvex.numberhelper.NumberToPercentageConverter}
 */
public class NumberToPercentageConverterBuilder {

    private HashMap<String, String> options;
    private double rawNumber;

    public NumberToPercentageConverterBuilder(double rawNumber){
